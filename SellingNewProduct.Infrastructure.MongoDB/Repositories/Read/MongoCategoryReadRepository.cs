...
/// <summary>
/// MongoDB read side for categories. With no JOIN, the products are loaded once and grouped per
/// category in memory to compute the product count and stock value. Soft-deleted categories and
/// products are excluded explicitly.
/// </summary>
