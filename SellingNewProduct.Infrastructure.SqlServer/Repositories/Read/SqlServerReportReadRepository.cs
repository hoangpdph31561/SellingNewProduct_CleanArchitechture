...
/// <summary>
/// SQL Server reporting: JOIN several tables + GROUP BY, aggregated on the database. The
/// aggregation is pushed down instead of pulling thousands of rows into the app to sum them.
/// Pure read side.
/// </summary>
internal sealed class SqlServerReportReadRepository : IReportReadRepository
{
    private readonly AppDbContext myAppDbContext;

    public SqlServerReportReadRepository(AppDbContext theAppDbContext)
    {
