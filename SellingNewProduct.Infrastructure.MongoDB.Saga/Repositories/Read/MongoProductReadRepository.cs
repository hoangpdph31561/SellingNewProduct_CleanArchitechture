...
/// <summary>
/// MongoDB read side for the catalogue. Product and category both live in MongoDB here, so the
/// "category name" stitch is a local lookup (no cross-store hop). Soft-deleted rows are excluded
/// explicitly; text "contains", sorting and paging run in memory.
/// </summary>
